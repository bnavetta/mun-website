...
{
    /*
     * There's not much here, but it's nice to have an abstraction over the Spring Data repository interface, and this
     * is a good place for any additional logic that comes up.
     */
