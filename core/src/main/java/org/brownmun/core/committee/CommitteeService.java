...
public interface CommitteeService
{
     ...
     * @return the saved committee. This object should be used instead of the passed-in one. When saving a new
     *     committee, this will have the {@link Committee#getId()} field populated.
     */
