    ...
    handleToggleOpen(committeeId) {
        this.setState({
            openMarkers: {
                ...
                [committeeId]: !this.state.openMarkers[committeeId],
            },
        });
    }
...
CommitteeMap = compose(
    withProps({
        googleMapURL:
            "https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry&key=AIzaSyD25YgeQlpx3Rg2N9P9K5eXJv8AUXRGbtE",
    ...
    withStateHandlers(
        ...
        }),
        {
            onToggleOpen: ({ openMarkers }) => committeeId => ({
                openMarkers: {
                    ...openMarkers,
                    [committeeId]: !openMarkers[committeeId],
                },
            }),
        }
    )
