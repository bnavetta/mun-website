...
class RegistrationForm extends React.PureComponent {
            ...
            >
                ...
                <fieldset>
                    ...
                    <ValidatedText
                        ...
                        field="schoolName"
                        id="schoolName"
                        validate={requiredValidator("School name is required")}
                    />
                </fieldset>
                ...
                <fieldset>
                    ...
                    <ValidatedText
                        ...
                        field="advisorName"
                        id="advisorName"
                        validate={requiredValidator("Advisor name is required")}
                    />
                </fieldset>
                ...
                <fieldset>
                    <label htmlFor="advisorPhoneNumber">
                    ...
                    <ValidatedText
                        ...
                        validate={requiredValidator("Phone number is required")}
                        type="tel"
                    />
                </fieldset>
                ...
                <fieldset>
                    ...
                    <ValidatedText
                        field="advisorPassword"
                        id="advisorPassword"
                        validate={requiredValidator(
                            "Advisor password is required"
                        )}
                        type="password"
                    />
                </fieldset>
                ...
                <p>
                    You will use this password with your email address to log
    ...
    render() {
        return <Form render={this.renderForm} onSubmit={this.handleSubmit} />;
    }
}
